...
from tools.models import get_cuid

from tools.models import Attestation, Audit, Modeler, Predicate, PredObj, NS, Project, Participation, ReferenceRange, SimpleReferenceRange, \
...
from tools.forms import ParticipationAdminForm, AttestationAdminForm, AuditAdminForm, SimpleRRAdminForm, ReferenceRangeAdminForm, PartyAdminForm, \
...
def delete_mcs(modeladmin, request, queryset):
    ...
    if cur_modeler:
        ...
        modeladmin.message_user(request, request.user.username +
                                " is not a registered tools modeler. ", messages.ERROR)
