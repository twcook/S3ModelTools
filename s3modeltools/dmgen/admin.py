...
@admin.action(
    description=_("Re-Publish (Development Only!)")
)
...
@admin.action(
    description=_("Re-Publish ALL (Development Only!)")
)
...
@admin.action(
    description=_("UnPublish (Development Only!)")
)
...
@admin.action(
    description=_("Unpublish ALL (Development Only!)")
)
...
@admin.action(
    description=_("Generate DM Package")
)
...
@admin.register(SimpleReferenceRange)
