...
from .models import DM, Attestation, Audit, XdBoolean, Cluster, XdCount, XdFile, XdFloat, XdInterval, XdLink, XdOrdinal, XdQuantity, XdRatio, XdString, XdTemporal, Units, \
     Participation, Party, ReferenceRange, Modeler

from s3mtools.settings import STATIC_ROOT
from .generator import generateDM
...
class IndexView(TemplateView):
    template_name = 'dmgen/index.html'
...
class ToolsView(TemplateView):
    template_name = 'dmgen/tools.html'
    sdir = STATIC_ROOT
...
class DMListView(ListView):
    ...
    template_name = 'dmgen/dm_list.html'
...
class DMUpdateView(UpdateView):
    model = DM
    form_class = DMForm
    template_name = 'dmgen/dm_form.html'
    success_url = '/dm_list'
...
class AttListView(ListView):
    ...
    template_name = 'dmgen/att_list.html'
...
class AttUpdateView(UpdateView):
    ...
    template_name = 'dmgen/att_form.html'
...
class AudListView(ListView):
    ...
    template_name = 'dmgen/aud_list.html'
...
class AudUpdateView(UpdateView):
    ...
    template_name = 'dmgen/aud_form.html'
...
class BoolListView(ListView):
    ...
    template_name = 'dmgen/bool_list.html'
...
class BoolUpdateView(UpdateView):
    ...
    template_name = 'dmgen/bool_form.html'
...
class CluListView(ListView):
    ...
    template_name = 'dmgen/clu_list.html'
...
class CluUpdateView(UpdateView):
    ...
    template_name = 'dmgen/clu_form.html'
...
class CntListView(ListView):
    ...
    template_name = 'dmgen/cnt_list.html'
...
class CntUpdateView(UpdateView):
    ...
    template_name = 'dmgen/cnt_form.html'
...
class FilListView(ListView):
    ...
    template_name = 'dmgen/fil_list.html'
...
class FilUpdateView(UpdateView):
    model = XdFile
    form_class = FileForm
    template_name = 'dmgen/fil_form.html'
...
class FltListView(ListView):
    ...
    template_name = 'dmgen/flt_list.html'
...
class FltUpdateView(UpdateView):
    ...
    template_name = 'dmgen/flt_form.html'
...
class IntListView(ListView):
    ...
    template_name = 'dmgen/int_list.html'
...
class IntUpdateView(UpdateView):
    ...
    template_name = 'dmgen/int_form.html'
...
class LnkListView(ListView):
    ...
    template_name = 'dmgen/lnk_list.html'
...
class LnkUpdateView(UpdateView):
    model = XdLink
    form_class = LinkForm
    template_name = 'dmgen/lnk_form.html'
...
class OrdListView(ListView):
    ...
    template_name = 'dmgen/ord_list.html'
...
class OrdUpdateView(UpdateView):
    ...
    template_name = 'dmgen/ord_form.html'
...
class PtnListView(ListView):
    ...
    template_name = 'dmgen/ptn_list.html'
...
class PtnUpdateView(UpdateView):
    ...
    template_name = 'dmgen/ptn_form.html'
...
class PtyListView(ListView):
    ...
    template_name = 'dmgen/pty_list.html'
...
class PtyUpdateView(UpdateView):
    ...
    template_name = 'dmgen/pty_form.html'
...
class QtyListView(ListView):
    ...
    template_name = 'dmgen/qty_list.html'
...
class QtyUpdateView(UpdateView):
    ...
    template_name = 'dmgen/qty_form.html'
...
class RatListView(ListView):
    ...
    template_name = 'dmgen/rat_list.html'
...
class RatUpdateView(UpdateView):
    ...
    template_name = 'dmgen/rat_form.html'
...
class RfrListView(ListView):
    ...
    template_name = 'dmgen/rfr_list.html'
...
class RfrUpdateView(UpdateView):
    ...
    template_name = 'dmgen/rfr_form.html'
...
class StrListView(ListView):
    ...
    template_name = 'dmgen/str_list.html'
...
class StrUpdateView(UpdateView):
    ...
    template_name = 'dmgen/str_form.html'
...
class TmpListView(ListView):
    ...
    template_name = 'dmgen/tmp_list.html'
...
class TmpUpdateView(UpdateView):
    ...
    template_name = 'dmgen/tmp_form.html'
...
class UntListView(ListView):
    ...
    template_name = 'dmgen/unt_list.html'
...
class UntUpdateView(UpdateView):
    ...
    template_name = 'dmgen/unt_form.html'
...
class ModUpdateView(UpdateView):
    ...
    template_name = 'dmgen/mod_form.html'
    success_url = '/'
