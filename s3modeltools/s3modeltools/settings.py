"""
Django settings for s3modeltools project.
...
DMLIB = config['S3MPython']['dmlib']
PRJPATH = config['S3MPython']['prjpath']
...
SECRET_KEY = 'django-insecure-(@32i=fbzjm9xof^$nan!u!5j4pzzf(8c4+a*ld5+)3hc%_qk6'
...
WSGI_APPLICATION = 's3modeltools.wsgi.application'
